...
export class Localization extends Datetime {
    ...
    */
    constructor(State) {
        ...
        this.currentLanguage = this.State.Settings.localization.language; // to be set in app.settings
    ...
    updateCurrentLanguage = (lang = null) => {
        ...
        this.State.Settings.localization.language ||
    ...
    getDefaultLanguageOfBrowser = () => {
        ...
        if (default_lan !== '' && default_lan) {
            ...
            return this.State.Settings.localization.language;
        }
    }
