    ...
    get Routes(){
        return {
            ...
            Meta: [
                ...
                // desktop
                { route: '/html/trout/index/desktop.html', device: 'desktop', attributes: { placementTag: 'main' }, cache: { validityTime: this.policies.Time.ZERO } },

                { route: '/html/trout/index/top-navbar.html', device: 'desktop', attributes: { placementTag: 'top-navbar' }, cache: { validityTime: this.policies.Time.ZERO } },
                { route: '/html/trout/index/side-navbar.html', device: 'desktop', attributes: { placementTag: 'side-navbar' }, cache: { validityTime: this.policies.Time.ZERO } },
                { route: '/html/trout/index/footer.html', device: 'desktop', attributes: { placementTag: 'footer' }, cache: { validityTime: this.policies.Time.ZERO } },

                // mobile
                { route: '/html/trout/index/mobile.html', device: 'mobile', attributes: { placementTag: 'main' }, cache: { validityTime: this.policies.Time.ZERO } },
